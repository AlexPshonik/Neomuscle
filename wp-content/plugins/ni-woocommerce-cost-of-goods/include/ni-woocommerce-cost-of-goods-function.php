			...
			echo '<div class="show_if_simple">'; 	
				woocommerce_wp_text_input( 
					array( 
						...
						'label'       => __( 'Оптовая цена', 'nicostofgoods' ), 
						'placeholder' => __( 'Оптовая цена', 'nicostofgoods' ),
						'desc_tip'    => 'true',
						'description' => __( 'Введите оптовую цену.', 'nicostofgoods' ) ,
		 ...
		 function ni_cost_of_goods_field($columns){
			...
			foreach ($columns as $column_name => $column_info) {
				...
				if ('price' === $column_name) {
					...
					$new_columns['ni_cost_goods'] = __( 'Оптовая цена'); 
				}
			}
			return $new_columns;
		 }

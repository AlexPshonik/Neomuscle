          ...
          <div class="feature-box">
            ...
            <div class="feature-item">
              ...
              <div class="feature-item-info">
                ...
                <p class="description">Постоянные акции и скидки</p>
              </div>
            </div>
      ...
      <div class="col-12">
        <div class="description-store-text">
          ...
          <ol>
            ...
            <li>С каждой покупкой мы предоставляем бесплатные пробники новых товаров чтобы Вы узнали о них, а также выбрали желаемый вкус;</li>
            ...
            <li>Мы обеспечили онлайн поддержку чтобы в кратчайшие сроки предоставить вам ответы на все интересующиеся вопросы.</li>
          </ol>
        </div>
